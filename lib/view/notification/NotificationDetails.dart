...
class NotificationDetails extends StatefulWidget {
  final String token;
  const NotificationDetails({Key? key,required this.token}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot<Map<String,dynamic>>>(
        stream: db.collection("/$deviceToken").snapshots(),
        builder: (context,AsyncSnapshot<QuerySnapshot<Map<String,dynamic>>> snapshot){
          if(snapshot.hasData) {
            return snapshot.data!.docs.isEmpty?Center(child: Image.asset("images/no-data.png"),):ListView.builder(
                              ...
                              Visibility(
                                ...
                                child: Card(
                                  ...
                                  child: IconButton(onPressed: (){
                                    setState(() {
                                      FirebaseFirestore.instance.collection("/$deviceToken").doc(e.id).delete();
                                    });
